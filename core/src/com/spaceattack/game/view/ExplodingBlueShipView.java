 ...
 */
public class ExplodingBlueShipView extends ObjectView{
     ...
     */
    public ExplodingBlueShipView(SpaceAttackGame game) {
        super(game);
    }
    ...
    private TextureRegion createRegion(SpaceAttackGame game) {
        Texture stopTexture = game.getAssetManager().get("animations/blueExplosion.png");
    ...
    private Animation<TextureRegion> createAnimation(SpaceAttackGame game) {
        Texture portalTexture = game.getAssetManager().get("animations/blueExplosion.png");
