...
/**
 * User Ship Shied View
 */
public class UserShipShieldView extends ObjectView{
     ...
     */
    public UserShipShieldView(SpaceAttackGame game) {
        super(game);
    }
    ...
    private TextureRegion createNotAcceleratingRegion(SpaceAttackGame game) {
        Texture noThrustTexture = game.getAssetManager().get("userShip/shipShield.png");
    ...
    private Animation<TextureRegion> createAcceleratingAnimation(SpaceAttackGame game) {
        Texture thrustTexture = game.getAssetManager().get("animations/user_Ship_Shield_Burst.png");
