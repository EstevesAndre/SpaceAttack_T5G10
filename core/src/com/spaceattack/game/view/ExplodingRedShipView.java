 ...
 */
public class ExplodingRedShipView extends ObjectView{
     ...
     */
    public ExplodingRedShipView(SpaceAttackGame game) {
        super(game);
    }
    ...
    private TextureRegion createRegion(SpaceAttackGame game) {
        Texture stopTexture = game.getAssetManager().get("animations/redExplosion.png");
    ...
    private Animation<TextureRegion> createAnimation(SpaceAttackGame game) {
        Texture portalTexture = game.getAssetManager().get("animations/redExplosion.png");
