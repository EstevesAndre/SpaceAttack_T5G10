 ...
 */
public class ExplodingYellowShipView extends ObjectView{
     ...
     */
    public ExplodingYellowShipView(SpaceAttackGame game) {
        super(game);
    }
    ...
    private TextureRegion createRegion(SpaceAttackGame game) {
        Texture stopTexture = game.getAssetManager().get("animations/yellowExplosion.png");
    ...
    private Animation<TextureRegion> createAnimation(SpaceAttackGame game) {
        Texture portalTexture = game.getAssetManager().get("animations/yellowExplosion.png");
