 ...
 */
public class ExplodingPurpleShipView extends ObjectView{
     ...
     */
    public ExplodingPurpleShipView(SpaceAttackGame game) {
        super(game);
    }
    ...
    private TextureRegion createRegion(SpaceAttackGame game) {
        Texture stopTexture = game.getAssetManager().get("animations/purpleExplosion.png");
    ...
    private Animation<TextureRegion> createAnimation(SpaceAttackGame game) {
        Texture portalTexture = game.getAssetManager().get("animations/purpleExplosion.png");
